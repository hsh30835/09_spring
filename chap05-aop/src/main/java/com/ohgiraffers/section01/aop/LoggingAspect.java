...
public class LoggingAspect {
    ...
    * */
     ...
     * 매개변수로 전달한 joinPoint 객체는 현재 조인 포인트의 메소드명, 인수값 등 자세한 정보를 액세스 할 수 있다.
     */
    ...
    /* aop가 적용될 메소드가 에러 없이 성공적으로 실행된 이후의 심저을 말한다.
    * returning : 반환될 매개변수를 의미한다.*/
    ...
    * 조인포인트는 진행하는 호출을 잊는 경우가 자주 발생하기 떄문에 주의해야 하며
